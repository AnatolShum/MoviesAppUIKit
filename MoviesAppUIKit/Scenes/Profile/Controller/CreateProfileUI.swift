...
extension ProfileController {
    func createProfileUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            nameHeaderLabel.leftAnchor.constraint(equalTo: nameHStack.leftAnchor, constant: 20),
            ...
            emailHeaderLabel.leftAnchor.constraint(equalTo: emailHStack.leftAnchor, constant: 20),
            ...
            memberSinceHeaderLabel.leftAnchor.constraint(equalTo: memberSinceHStack.leftAnchor, constant: 20),
